...
if __name__ == '__main__':
    ...
    for idx in range(0, len(user_samples_list)):
        ...
        print('Sample data set {}\n\tEvents: {}\n\tUsers: {}\n\tSessions: {}\n\tItems: {}\n\tSpan: {} / {}\n\n'.
              format(idx, len(user_samples), user_samples[USER_KEY].nunique(), user_samples[SESSION_KEY].nunique(),  user_samples[ITEM_KEY].nunique(),
    ...
    #2 # need to reset your indexes after shuffling: df.reset_index(inplace=True, drop=True)
    # from sklearn.utils import shuffle
    # users_df = shuffle(users_df)
    ...
    # pd.merge(users1, users2, how='inner', on=['visitorid'])
    # users1.intersection(users2)
