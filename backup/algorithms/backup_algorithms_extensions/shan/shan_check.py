...
# 
    ...
    def predict_last(self, session_id, input_item_id, input_user_id, predict_for_item_ids=None, timestamp=None):

        top_index_all, top_value_all = self.model.predict_last(session_id,input_item_id,input_user_id)
...
class shan():
    ...
    def predict_last(self,session_id, item_id, user_id):
        ...
        top_index_all, top_value_all = self.sess.run(
                ...
                feed_dict={self.user_id: [self.dg.user2id[user_id]],
                           ...
                           self.current_session: self.batch_session[:-1],
