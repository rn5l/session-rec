...
class UVMContextKNN:
    ...
    def __init__(self, k, sample_size=1000, sampling='recent', similarity='cosine', weighting='div',
                 ...
                 remind=True, push_reminders=False, add_reminders=False, extend=False,
                 extend_session_length=None, extending_mode='lastViewed', refine_mode=True, boost_own_sessions=None, past_neighbors=False,
        ...
        self.refine_mode = refine_mode # user_based
