...
class Saver:
    ...
    def reset(self):
        ...
        self.recommendations['UserId'] = []
        self.recommendations['SessionId'] = []
        self.recommendations['Position'] = []
        self.recommendations['Recommendations'] = []
        self.recommendations['Scores'] = []
     
    # def skip(self, for_item = 0, user= -1, session = -1 ): #needed?
    #     pass
        
    def add(self, result, next_item, for_item=0, session=0, pop_bin=None, position=None, user=0): #TODO: user=0 must be added for all metrics
        '''
        ...
        self.recommendations['UserId'].append( user )
    ...
    def add_multiple(self, result, next_items, for_item=0, session=0, position=None, user=0): #TODO: user=0 must be added for all metrics
        self.add(result, next_items[0], for_item, session=session, position=position, user=user) #TODO??? user=0 must be added for all metrics
